//======================================================================================
   char titel[]="Timer_06 Vorgabe\n";

/*  Erstellen Sie ein Programm, 
    bei dem Timer 0 im Modus 2 eine augewahlte LED für eine bestimmte Zeit einschaltet.
    Der Timer1 soll alle 100µs einen Überlauf erzeugen.
 a) Die Auswahl des Ausgabeports geschieht mit Hilfe der Taster P3.2 bis P3.5
 b) Die Auswahl der Blinkfrequenz geschieht mit Hilfe des AD-Wandlers an P6.3
...
unsigned ziel;                    // 2=P3.2, 3=P3.3, 4=P4.4, 5=P3.5
...
void main(void)                  // Timer zählt Sekunden per Interrupt 
  ...
  init_ad();
  printstring(titel);            // Titel ausgeben
