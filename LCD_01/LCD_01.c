...
void main(void) 
  ...
  EAL=1;
  printstring("Geben Sie etwas ein: ");
  putchar('\n');
  while(1)
    {
      c=getchar();
...
void printbytedez(unsigned char zahl)
  ...
  ziffer=zahl/100;              // Hunderter Ziffer ermitteln
  putchar(ziffer + '0');        // ASCII seriell ausgeben
  zahl=zahl%100;                // Hunderterr Ziffer entfernen
  ziffer=zahl/10;               // Zehner Ziffer ermitteln
  putchar(ziffer + '0');        // ASCII seriell ausgeben
  zahl=zahl%10;                 // Zehner Ziffer entfernen
  ziffer=zahl;                  // Einer Ziffer
  putchar(ziffer + '0');        // ASCII seriell ausgeben
  }	
//---------------------------------------------------------------------------------------
char getchar(void)
